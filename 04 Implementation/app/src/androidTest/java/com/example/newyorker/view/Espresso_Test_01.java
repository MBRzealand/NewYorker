...
public class Espresso_Test_01 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void espresso_Test_01() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.height_editText), withText("150"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textview_price_main_activity), withText("6272.22"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("6272.22")));
    }
